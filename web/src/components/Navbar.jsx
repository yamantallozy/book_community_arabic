    ...
    return (
        <nav className="flex justify-between items-center px-6 py-4 bg-white shadow-sm sticky top-0 z-50">
            ...
            <div className="flex items-center gap-6">
                ...
                <Link to="/my-books" className="text-slate-600 hover:text-primary font-medium transition-colors">My Books</Link>
                ...
                {user ? (
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Link to="/register" className="bg-primary hover:bg-indigo-700 text-white px-5 py-2 rounded-lg font-medium shadow-md hover:shadow-lg transition-all">Register</Link>
                    </div>
                )}
            </div>
        </nav>
